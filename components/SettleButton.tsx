...
export function SettleButton({ expenseId, settler, settled, onSuccess }: SettleButtonProps) {
  ...
  if (settled) {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-white/20 bg-white/5 px-4 py-3 text-neutral-100">
  ...
  return (
    <div>
      <button
        ...
        disabled={inFlight}
        className="flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 font-medium text-black transition-colors hover:bg-neutral-200 disabled:cursor-not-allowed disabled:opacity-60"
      >
